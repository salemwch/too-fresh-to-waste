...
export function EditOfferModal({ offer, isPending, onClose, onConfirm, t }: EditOfferModalProps) {
  ...
  const field =
    'w-full rounded-lg border border-slate-200 px-md py-sm text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500';
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center p-lg'>
      ...
      >
        <div className='flex items-center gap-sm px-xl py-md border-b border-slate-100 shrink-0'>
        ...
        <div className='flex-1 overflow-y-auto px-xl py-lg space-y-lg'>
            ...
            <div className='flex flex-wrap gap-1.5'>
              {DISCOUNT_OPTIONS.map(option => (
                <button
                  ...
                  className={cn(
                    'rounded-lg px-2.5 py-xs text-xs font-semibold border transition-colors',
                    discount === option
          ...
          <div className='rounded-lg bg-slate-50 px-md py-2.5 flex items-baseline justify-between'>
        ...
        <div className='flex gap-sm px-xl py-md border-t border-slate-100 shrink-0'>
          <button
            type='button'
            onClick={onClose}
            className='flex-1 rounded-xl border border-slate-200 px-lg py-2.5 text-sm font-semibold text-slate-600 hover:bg-slate-50'
          >
          ...
          <button
            ...
            className={cn(
              'flex-1 rounded-xl bg-primary-500 px-lg py-2.5 text-sm font-semibold text-white',
