...
export default function Header() {
  ...
  const NAV_LINKS: NavLink[] = [
    ...
    { label: t('nav.businessSolution'), href: '#business' },
  ];
    ...
    <>
      ...
      >
        <div className="container mx-auto px-2 lg:px-0">
          <nav className="grid grid-cols-[auto_1fr_auto] lg:flex lg:items-center lg:justify-between items-center h-20 gap-4" role="navigation" aria-label="Main navigation">

            {/* Left: Logo */}
            <div className="flex items-center">
              <Link href="/" aria-label="Too Fresh To Waste Home">
                <div className="relative w-20 lg:w-28 xl:w-40 h-10 lg:h-14 xl:h-20">
                  {/* Green logo (visible when not scrolled) */}
                  <Image
        ...
        >
          ...
          >
            <div className="px-4 py-6 space-y-1">
              ...
              {/* Divider */}
              <div className={`my-4 border-t ${isScrolledState ? 'border-primary-500/20' : 'border-white/20'}`} />
