  ...
  const items: MarqueeItem[] = [
    {
      ...
      icon: (
        <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M12 6C11.45 6 11 6.45 11 7V12.41L8.29 15.12C7.9 15.51 7.9 16.15 8.29 16.54C8.68 16.93 9.32 16.93 9.71 16.54L12.71 13.54C12.9 13.35 13 13.09 13 12.83V7C13 6.45 12.55 6 12 6Z" fill="white" opacity="0.8"/>
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M19 5H17.83L15 2.17C14.8 1.97 14.52 1.88 14.24 1.91C13.96 1.95 13.71 2.11 13.59 2.36L12 5.54L10.41 2.36C10.29 2.11 10.04 1.95 9.76 1.91C9.48 1.88 9.2 1.97 9 2.17L6.17 5H5C3.9 5 3 5.9 3 7V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V7C21 5.9 20.1 5 19 5ZM12 4.41L13.1 6.47C13.32 6.91 13.77 7.16 14.24 7.09C14.71 7.02 15.09 6.65 15.16 6.18L16.59 5H18L12 15L6 5H7.41L8.84 6.18C8.91 6.65 9.29 7.02 9.76 7.09C10.23 7.16 10.68 6.91 10.9 6.47L12 4.41ZM19 19H5V7H6.41L12 16.28L17.59 7H19V19Z" fill="white"/>
        </svg>
      ),
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M12 15L9.5 13.5L7 15L7.75 12.25L5.5 10.25L8.25 10L9.5 7.5L10.75 10L13.5 10.25L11.25 12.25L12 15Z" fill="white" opacity="0.9"/>
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Burger Icon */}
          <path d="M12 2C11.45 2 11 2.45 11 3C11 3.55 11.45 4 12 4C16.41 4 20 7.59 20 12C20 12.55 20.45 13 21 13C21.55 13 22 12.55 22 12C22 6.48 17.52 2 12 2Z" fill="white" opacity="0.7"/>
          ...
          <path d="M7 13C6.45 13 6 13.45 6 14V16C6 16.55 6.45 17 7 17H17C17.55 17 18 16.55 18 16V14C18 13.45 17.55 13 17 13H7Z" fill="white"/>
