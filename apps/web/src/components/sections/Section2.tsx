  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-6xl">
        ...
        >
          {t('title')}
          <span className="inline-block ml-2 text-4xl md:text-5xl lg:text-6xl" role="img" aria-label="rewards">
            🎁
          </span>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
          ...
          >
            ...
            <div className="flex flex-col items-start justify-center">
              ...
              <div className="text-base font-semibold leading-tight">{t('downloadButtons.appStore.name')}</div>
            </div>
          </a>
          ...
          >
            ...
            <div className="flex flex-col items-start justify-center">
              <div className="text-[9px] leading-tight">{t('downloadButtons.playStore.prefix')}</div>
              <div className="text-base font-semibold leading-tight">{t('downloadButtons.playStore.name')}</div>
            </div>
          </a>
        </div>
      </div>
