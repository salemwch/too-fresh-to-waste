  ...
  return (
    ...
    >
      <div className='container mx-auto max-w-6xl'>
        ...
        <h2
          id='app-heading'
          className='sr-up text-primary-500 text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-2xl leading-tight'
        >
          {t('title')}
          <span
        ...
        {/* Subtitle */}
        <p
          className='sr-up text-[#5F6D6D] text-base md:text-lg lg:text-xl text-center mb-3xl max-w-4xl mx-auto leading-relaxed'
        ...
        {/* Download Buttons */}
        <div
          className='sr-up flex flex-col sm:flex-row gap-md justify-center items-center'
        ...
        >
          ...
          >
            ...
            <div className='flex flex-col items-start justify-center'>
              <div className='text-xs leading-tight'>{t('downloadButtons.appStore.prefix')}</div>
          ...
          >
            ...
            <div className='flex flex-col items-start justify-center'>
              <div className='text-xs leading-tight'>{t('downloadButtons.playStore.prefix')}</div>
              <div className='text-base font-semibold leading-tight'>
