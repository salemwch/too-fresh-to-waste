    ...
    <Card>
      ...
      {state === 'success-merchant' && (
        <CardHeader className="space-y-3 text-center">
          ...
          <CardDescription className="text-base">{t('verifySuccessRedirecting')}</CardDescription>
        </CardHeader>
      )}
      ...
      {state === 'success-consumer' && (
        <>
          ...
          <CardContent className="flex flex-col items-center gap-3 pt-2">
            <p className="text-sm font-medium text-muted-foreground">{t('verifySuccessOpenApp')}</p>
            {/* Google Play */}
            <a
            ...
            >
              ...
              <div className="leading-tight text-white">
                <div className="text-[9px] font-normal uppercase tracking-wide">
                  DOWNLOAD ON THE
                </div>
