...
const TEXT_MUTED = colorTokens.base.neutral[800];
const BORDER = colorTokens.base.neutral[300];
const SURFACE_MUTED = colorTokens.base.neutral[200];
const INPUT_SURFACE = colorTokens.base.neutral[50];
const SUCCESS = colorTokens.base.success[500];
const DISABLED = colorTokens.base.neutral[500];
