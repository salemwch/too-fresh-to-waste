package com.foodwasteapp; // Replace with your actual package name
...
/**
 * This is a helper class to generate your app hash for SMS Retriever API.
 * USE THIS ONCE TO GET YOUR HASH, THEN REMOVE THIS FILE.
 *
        ...
        try {
            ...
            for (Signature signature : signatures) {
                ...
                if (hash != null) {
                    ...
                    Log.d(TAG, String.format("App Hash: %s", hash));
                }
            }
