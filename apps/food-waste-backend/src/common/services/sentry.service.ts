    ...
    initialize(): void {
        ...
        try {
            Sentry.init({
                ...
                release: this.configService.get('SENTRY_RELEASE') ||
                ...
                beforeSend: (event, hint) => {
                    return this.beforeSend(event) as Sentry.ErrorEvent;
                },
    ...
    private beforeSend(event: Sentry.Event): Sentry.Event | null {
        ...
        if (event.request) {
            ...
            if (event.request.data && typeof event.request.data === 'object') {
                ...
                this.redactSensitiveFields(event.request.data, sensitiveFields);
            }
        }
        ...
        if (event.extra) {
            ...
            this.redactSensitiveFields(event.extra, sensitiveFields);
        }
