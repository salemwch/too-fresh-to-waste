...
export class ReviewEventListener {
    ...
    async handleReviewCreatedEventRabbitMQ(payload: any): Promise<void | Nack> {
        try {
            this.logger.log(`[RabbitMQ] Processing review created event for review ${payload.review?._id || 'unknown'}`);
    ...
    async handleReviewUpdatedEventRabbitMQ(payload: any): Promise<void | Nack> {
        try {
            this.logger.log(`[RabbitMQ] Processing review updated event for review ${payload.review?._id || 'unknown'}`);
    ...
    async handleReviewDeletedEventRabbitMQ(payload: any): Promise<void | Nack> {
        try {
            this.logger.log(`[RabbitMQ] Processing review deleted event for review ${payload.reviewId || 'unknown'}`);
    ...
    async handleReviewModeratedEventRabbitMQ(payload: any): Promise<void | Nack> {
        try {
            this.logger.log(`[RabbitMQ] Processing review moderation event for review ${payload.reviewId || 'unknown'}`);
    ...
    private async processReviewModerated(payload: ReviewModeratedEvent): Promise<void> {
        ...
        this.logger.log(`Successfully processed review moderation event for review ${payload.reviewId}`);
    }
    ...
    async handleReviewAnalyzedEventRabbitMQ(payload: any): Promise<void | Nack> {
        try {
            this.logger.log(`[RabbitMQ] Processing review analysis completion for review ${payload.reviewId || 'unknown'}`);
    ...
    async handleReviewAnalyzedEventLegacy(payload: ReviewAnalyzedEvent): Promise<void> {
        try {
            this.logger.log(`[Legacy] Processing review analysis completion for review ${payload.reviewId}`);
